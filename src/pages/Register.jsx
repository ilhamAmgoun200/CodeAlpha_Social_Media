...
import { Loading, TextInput, CustomButton } from "../components"; // Chemin correct selon la structure
         ...
         <div className="w-full flex flex-col lg:flex-row gap-1 md:gap-2">
          ...
          <TextInput
            ...
            register={ register("email", {
                    required: "Email Adress os required",
            })}
            styles="w-full"
          ...
          />
           ...
           { errMsg?.message && (
...

            {
              ...
              <CustomButton 
                type="submit"
                containerStyles={`inline-flex justify-center rounded-md bg-blue px-8 py-3 text-sm font-medium text-while outline-none`}

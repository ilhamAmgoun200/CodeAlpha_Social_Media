...
const ReplyCard = ({ reply, user , handleLike}) => {
    return <div className='w-full py-3'>
        <div className='flex gap-3 items-center mb-1'>
            ...
            <div>
                ...
                <p className='font-medium text-base text-ascent-1'>
                   {reply?.usedId.firstName} {reply?.usedId?.lastName}
        ...
        <div className='ml-12'>
           <p className='text-ascent-2'> {reply?.comment}
...
const CommentForm = ({user, id, replyAt,getComments}) => {
    ...
    return <form onSubmit={handleSubmit(onSubmit)} className='w-full border-b border-[#66666645]'>
...
const PostCard = ({post,user,deletePost,likePost}) => {
  ...
  return <div className='mb-2 bg-primary p-4 rounded-x1'>
    ...
    <div >
        <p className='text-ascent-2'>
            ...
            (showAll == post?._id ? (
                    <span  className='text-blue m1-2 font-mediu cursor-pointer'
                    ...
                    <span 
                    className='text-blue m1-2 font-medium cursor-pointer'
